export const siteConfig = {
  ...
  description:
    "Memberdayakan generasi profesional multimedia berikutnya melalui pendidikan inovatif, teknologi mutakhir, dan keunggulan kreatif.",
...
export const heroContent = {
  ...
  tagline: "Membangun Kreativitas dan Teknologi",
  description:
    "Memberdayakan generasi profesional berikutnya melalui pendidikan inovatif, teknologi informasi, dan keunggulan kreatif.",
...
export const visionMission = {
  vision: {
    title: "Visi",
    content:
      "Menjadi Program Studi Unggulan pada Jenjang Pendidikan Diploma Empat (D4) bidang Teknik Informatika Multimedia di Tingkat Nasional.",
  },
  mission: {
    title: "Misi",
    items: [
