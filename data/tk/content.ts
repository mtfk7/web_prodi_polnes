...
export const programHighlights = [
  {
    ...
    description: 'Memahami struktur internal komputer, prosesor, memori, dan sistem input/output',
    gradient: 'from-teal-50 to-teal-100',
    iconGradient: 'from-teal-600 to-teal-700',
  },
  {
    icon: 'Zap',
    title: 'Rangkaian Listrik & Elektronika',
    description: 'Menguasai dasar-dasar rangkaian listrik dan elektronika untuk sistem komputer',
  ...
  },
  {
    ...
    description: 'Merancang, mengkonfigurasi, dan mengelola jaringan komputer lokal dan wide area',
    gradient: 'from-blue-50 to-cyan-100',
    iconGradient: 'from-blue-600 to-cyan-500',
  },
  {
    icon: 'Code2',
    title: 'Pemrograman & Sistem Operasi',
    description: 'Menguasai pemrograman dasar dan memahami cara kerja sistem operasi komputer',
...
export const visionMission = {
  vision: {
    title: 'Visi',
    content: 'Menjadi Program Studi Unggulan pada Jenjang Pendidikan Diploma Tiga (D3) bidang Teknik Komputer di Tingkat Nasional.',
  },
  mission: {
    title: 'Misi',
    items: [
      'Menyelenggarakan pendidikan bidang teknik informatika multimedia yang berkualitas, inovatif dan mengacu kepada kebutuhan di masa depan dengan tata kelola yang profesional.',
...
export const departmentProfile = {
  ...
  stats: [
    { value: '1000+', label: 'Lulusan', color: 'text-teal-600' },
    { value: '10+', label: 'Dosen Ahli', color: 'text-teal-600' },
    { value: '7+', label: 'Tahun Pengalaman', color: 'text-teal-600' },
    { value: '95%', label: 'Tingkat Penyerapan Kerja', color: 'text-teal-600' },
  ],
  activeStudents: '400+',
...
export const achievements = [
  ...
  },
  {
    ...
    description: 'Juara 1 Kompetisi Jaringan Komputer 2024',
