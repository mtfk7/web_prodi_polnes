...
export const visionMission = {
  vision: {
    title: "Visi",
    content:
      "Menjadi Program Studi Unggulan pada Jenjang Pendidikan Diploma Empat (D4) bidang Teknologi Rekayasa Komputer di Tingkat Nasional.",
  },
  mission: {
    title: "Misi",
    items: [
      "Menyelenggarakan pendidikan bidang Teknologi Rekayasa Komputer yang berkualitas, inovatif dan mengacu kepada kebutuhan di masa depan dengan tata kelola yang profesional.",
...
export const departmentProfile = {
  ...
  description:
    "Program Studi Teknologi Rekayasa Komputer Politeknik Negeri Samarinda telah menjadi pelopor pendidikan digital dan teknologi informasi sejak didirikan pada tahun 2018. Dengan menggabungkan pengetahuan teoretis dengan keterampilan praktis untuk mempersiapkan mahasiswa menghadapi perkembangan dunia digital dan teknologi yang pesat.",
  stats: [
    { value: "1000+", label: "Lulusan", color: "text-cyan-600" },
    { value: "10+", label: "Dosen Ahli", color: "text-cyan-600" },
    { value: "7+", label: "Tahun Pengalaman", color: "text-cyan-600" },
    { value: "95%", label: "Tingkat Penyerapan Kerja", color: "text-cyan-600" },
  ],
  activeStudents: "400+",
