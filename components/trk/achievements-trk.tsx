...
import { achievements } from '@/data/trk/content';
    ...
    <section className="py-20 bg-white">
      <div className="container px-4">
        <div className="text-center mb-16">
          <Badge className="mb-4 bg-amber-200 text-amber-900 px-4 py-2 text-sm">Penghargaan & Pencapaian</Badge>
          ...
          {achievements.map((achievement, index) => {
            ...
            return (
              <Card key={index} className="text-center group hover:shadow-lg transition-shadow">
                <CardHeader>
                  <IconComponent className={`h-12 w-12 ${achievement.color} mx-auto mb-4 group-hover:scale-110 transition-transform`} />
