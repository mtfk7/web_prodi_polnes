...
import { departmentProfile } from "@/data/ti/content"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              {/* <Button className="bg-gradient-to-r from-emerald-700 to-emerald-900 hover:from-emerald-800 hover:to-emerald-950">
                Learn More About Us
              </Button> */}
            </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-2xl font-bold text-emerald-700">{departmentProfile.activeStudents}</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
