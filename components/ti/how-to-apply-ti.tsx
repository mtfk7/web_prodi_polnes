...
export function HowToApply() {
  return (
    <section id="cara-mendaftar" className="py-20 bg-gradient-to-br from-emerald-700 to-emerald-900">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <Link href="https://pmb.polnes.ac.id/" target="_blank" rel="noopener noreferrer">
                <Button className="bg-white text-emerald-700 rounded-2xl hover:text-emerald-700 hover:bg-gray-100 hover:scale-105 font-bold text-lg shadow-lg transition-transform duration-200">Daftar Sekarang</Button>
              </Link>
