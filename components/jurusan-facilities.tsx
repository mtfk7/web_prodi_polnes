...
const facilities = [
  ...
  {
    title: 'Laboratorium Rekayasa Komputer',
    description: 'Fasilitas untuk praktik konfigurasi jaringan dan keamanan sistem',
    image: '/lab-rekayasa.png?height=200&width=400',
    icon: Wifi,
    color: 'text-green-700',
  },
  {
    title: 'Laboratorium Multimedia',
    description: 'Lab khusus untuk pembelajaran multimedia',
  ...
  },
  {
    ...
    description:
      'Jurusan Teknologi Informasi memiliki fasilitas lapangan multifungsi yang dapat digunakan untuk bermain basket maupun voli. Area ini menjadi tempat kegiatan olahraga, pertandingan internal, hingga ajang kebersamaan antar mahasiswa.',
  ...
  },
  {
    ...
    description:
      'Terletak di lantai 4 gedung Jurusan Teknologi Informasi, aula ini digunakan untuk berbagai kegiatan akademik dan non-akademik seperti seminar, workshop, sidang, hingga acara internal kampus. Dilengkapi dengan proyektor, sound system, dan kapasitas yang cukup luas, ruang ini menjadi salah satu fasilitas penting di jurusan.',
  ...
  {
    title: 'Store Room',
    description: 'Ruang penyimpanan dan peminjaman peralatan seperti laptop, kamera, tripod, dan perangkat teknologi lainnya yang dapat dipinjam mahasiswa untuk keperluan pembelajaran dan proyek akademik.',
    image: '/storeroom.jpeg?height=200&width=400',
    icon: Presentation,
    color: 'text-teal-700',
  },
  {
    title: 'Lab Grafika',
    description: 'Laboratorium khusus untuk pembelajaran desain grafis dan multimedia dengan perangkat lunak terbaru',
    image: '/lab-grafika.png?height=200&width=400',
    icon: ParkingCircle,
    color: 'text-red-700',
  },
];
