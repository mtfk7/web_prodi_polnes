...
import { visionMission } from "@/data/jurusan/content"

export function VisionMission() {
  return (
     <section id="visi-dan-misi" className="py-20 bg-gradient-to-br from-green-600 to-green-900">
      <div className="container px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-amber-400 py-2 px-4 text-gray-800 font-bold hover:text-gray-900 hover:bg-amber-450">Visi & Misi Jurusan</Badge>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <Card className="bg-white/10 backdrop-blur border-white/20 text-white">
              ...
              <CardContent>
                <p className="text-lg leading-relaxed text-green-100">{visionMission.vision.content}</p>
              </CardContent>
            </Card>
