...
import { facilities } from '@/data/tk/content';
...
const iconColors = {
  Microscope: 'text-teal-700',
  Palette: 'text-teal-700',
  Building2: 'text-teal-700',
  Book: 'text-teal-700',
  Building: 'text-teal-700',
};
    ...
    <section id="fasilitas" className="py-20 bg-gray-50">
      <div className="container px-4">
        <div className="max-w-6xl mx-auto text-center">
          <Badge className="px-4 py-2 text-sm mb-4 bg-teal-100 text-teal-800">Fasilitas</Badge>
