...
import { lecturers } from '@/data/tk/lecturers';
  ...
  return (
    <section id="daftar-dosen" className="py-20 bg-white relative overflow-hidden">
      <div className="container px-6 text-center">
        <Badge className="py-2 px-4 hover:bg-cyan-200 mb-6 bg-cyan-100 text-cyan-800 px-4 py-2 shadow-lg">Dosen Prodi TK</Badge>
