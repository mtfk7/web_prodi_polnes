...
import { Code2, Link as LucideLink, Palette, Smartphone, Sparkles, ChevronDown, ChevronUp, Cpu, Zap, Network } from 'lucide-react';
    ...
    <section id="kurikulum" className="py-20 bg-teal-50">
      <div className="container px-4">
        <div className="text-center mb-16">
          <Badge className="px-4 py-2 text-sm mb-4 bg-teal-100 text-teal-800">Sorotan Kurikulum</Badge>
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Kurikulum Selalu Relevan</h2>
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto leading-relaxed">
            Program D3 Teknik Komputer menawarkan pengalaman belajar lengkap yang menggabungkan pengetahuan teoretis dengan keterampilan praktis dalam bidang teknologi komputer.
          </p>
        </div>
