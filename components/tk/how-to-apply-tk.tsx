...
export function HowToApply() {
  return (
    <section id="cara-mendaftar" className="py-20 bg-gradient-to-br from-teal-700 to-teal-900">
      <div className="container px-4 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            <Badge className="mb-4 bg-white px-4 py-2 text-teal-800 text-sm font-bold shadow-lg hover:bg-gray-100 hover:text-teal-700">Pendaftaran</Badge>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="absolute -bottom-6 left-1/2 w-max -translate-x-1/2 sm:left-[-1.5rem] sm:translate-x-0 bg-white/90 backdrop-blur-md shadow-2xl border border-[#11418B]/30 rounded-2xl overflow-hidden">
                ...
                <div className="p-3 relative z-10 flex items-center gap-3">
                  <div className="relative">
                    ...
                    <div className="relative bg-gradient-to-br from-teal-600  to-teal-800 p-3 rounded-xl">
                      <Award className="h-6 w-6 text-yellow-500" />
                    </div>
                  </div>
                  <div>
                    <div className="font-semibold text-sm text-teal-700 mb-0.5">Pendaftaran Dibuka</div>
            ...
            <div>
              ...
              <Link href="https://pmb.polnes.ac.id/" target="_blank" rel="noopener noreferrer">
                <Button className="bg-white text-teal-700 rounded-2xl hover:text-teal-700 hover:bg-gray-100 hover:scale-105 font-bold text-lg shadow-lg transition-transform duration-200">Daftar Sekarang</Button>
              </Link>
