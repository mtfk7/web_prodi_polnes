      ...
      <div className="container px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-teal-100 text-teal-700">Pendaftaran</Badge>
            ...
            <CardContent>
              ...
              <div className="text-center">
                <Link href="https://pmb.polnes.ac.id/" target="_blank" rel="noopener noreferrer">
                  <Button
                    size="lg"
                    className="text-sm text-white bg-gradient-to-r from-teal-400 to-teal-400 hover:from-teal-300 hover:to-teal-300"
                  >
                    Daftar Sekarang
                  </Button>
                </Link>
                <p className="text-sm text-white-800 mt-4">Batas akhir pendaftaran: 31 Juli 2025</p>
              </div>
            </CardContent>
          </Card>
        </div>
