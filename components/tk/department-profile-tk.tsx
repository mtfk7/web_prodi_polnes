...
import { departmentProfile } from "@/data/tk/content"
      ...
      <div className="container px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <Badge className="mb-4 bg-teal-100 text-teal-800">{departmentProfile.badge}</Badge>
              ...
              {/* <Button className="bg-gradient-to-r from-teal-700 to-teal-900 hover:from-teal-800 hover:to-teal-950">
                Learn More About Us
              </Button> */}
            </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-2xl font-bold text-teal-700">{departmentProfile.activeStudents}</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
