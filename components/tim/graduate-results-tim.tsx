...
export function GraduateResults() {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-blue-700 to-emerald-800">
      <style jsx>{`
        .slide-in-from-right {
      ...
      <div className="container px-4">
        <div className="text-center mb-16">
          <Badge className="mb-4 bg-white text-blue-800">Testimoni Alumni</Badge>
                  ...
                  <CardHeader>
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div className="flex-1">
                        ...
                        <CardDescription className="text-blue-200 text-sm transition-colors duration-300">
                    ...
                    <div className="relative">
                      <Quote className="h-6 w-6 text-blue-300 absolute -top-2 -left-2 opacity-50 transition-transform duration-300 hover:scale-100" />
                      <CardDescription className="text-blue-100 text-base leading-relaxed pl-4 transition-colors duration-300">
                    ...
                    <div className="mt-4 pt-4 border-t border-white/20">
                                              <Badge
                        variant="outline"
                        className="text-blue-200 border-blue-300/30 transition-all duration-300 hover:bg-blue-200 hover:text-blue-800"
                      >
