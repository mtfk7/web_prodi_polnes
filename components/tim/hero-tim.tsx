    ...
    <section id="beranda" className="relative overflow-hidden min-h-screen flex items-center">
      ...
      <div className="absolute inset-0 z-0">
        {campusImages && campusImages.length > 0 ? (
          <>
            ...
            {/* Gradient Overlay */}
            <div className="absolute inset-0 bg-gradient-to-br from-blue-800/85 via-blue-900/75 to-emerald-900/85 z-20" />
          ...
          <>
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-blue-800/85 via-blue-900/75 to-emerald-900/85" />
            {/* Dark Overlay for better text readability */}
      ...
      <div className="relative z-40 container px-4 py-24 md:py-32">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-xl md:text-2xl mb-8 text-blue-100 font-light drop-shadow-md">{heroContent.tagline}</p>
          <p className="text-lg mb-10 text-blue-100 max-w-2xl mx-auto drop-shadow-md">{heroContent.description}</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              asChild
              size="lg"
              className="bg-blue-700 text-white hover:bg-blue-600 font-semibold shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-2"
            >
